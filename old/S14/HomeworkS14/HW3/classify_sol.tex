\begin{solution}
\begin{enumerate}
\item[(1.1)][5 points] ODE, first order, linear, homogeneous, variable coefficient\\
      The $2/x$ factor in front of the $v$ is the variable coefficient.
\item[(1.2)][5 points] PDE, first order, linear, inhomogeneous, constant coefficient\\
      The $x-t$ term on the right, which does not involve $v$, makes the
      equation inhomogeneous.
\item[(1.3)][3 points] PDE, second order, nonlinear\\
...
\item[(1.4)][3 points] PDE, third order, nonlinear\\
...
\item[(1.5)][3 points] ODE, second order, nonlinear\\
      The $(1-y^2) (dy/dx)$ term makes this ODE nonlinear.
\item[(1.6)][6 points] ODE, fourth order, linear, inhomogeneous, variable coefficient\\
      Using the product rule for partial derivatives, we can write this
      equation in the equivalent form
      \[
2 {d^2u \over dx^2} 
