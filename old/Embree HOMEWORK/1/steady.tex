...
\item  If the heat flux is fixed at $\gamma\ {\rm J}/({\rm m}^2\cdot {\rm sec})$  on the left end of the bar,
        we have  \[ q(0) = \gamma.\]
        ...
        [\textbf{GRADERS}: 
        If students directly assumed that $\d u(0)/\d t = \gamma$ without appeal to 
         Fourier's Law, please deduct 5~points.]
