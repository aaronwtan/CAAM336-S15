...
\item Suppose $\kappa = 0.80\;\mbox{W/(cm K)}$,
      $\rho = 7.6\;\mbox{g/cm}^3$, and $c = 0.45\; \mbox{J/(g K)}$
      (approximate values for iron found in the \emph{CRC Handbook of
       Chemistry and Physics}, and on the web),
