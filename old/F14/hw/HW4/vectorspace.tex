For each part, if the set is not a vector space, please show what properties of a vector space are violated.  Otherwise, show that all properties of a vector space are satisfied.  
\begin{enumerate}
