Let $H^1_D\left(0,1\right)=\{w\in H^1(0,1):\,w(0)=w(1)=0\}$ and let the inner product $a\ip{\cdot,\cdot}:H^1_D\left(0,1\right)\times H^1_D\left(0,1\right)\to\R$ be defined by
\[
