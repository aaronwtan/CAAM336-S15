...
\item Using the specific values of $x_i$ given at the beginning of the problem and specific $f(x) = e^x$, set up the matrix equation $Au=b$ for part (b).  Verify that ${\bf e}$ is in the null space of ${A}$, where ${\bf e} = (1,1,1)^T$ is the vector of all ones.  What does this imply about the solution to the system?  
