...
\]
In other words, give expressions for the coefficients $\alpha_j,\beta_j, \beta_0$ that depend on $c_j, d_j, d_0$, and $\lambda_j$ or $\mu_j$.  \emph{You may use without proof that $\phi_j, \psi_j$, and $\psi_0$ are linearly independent.}% and orthogonal under the inner product $(f,g) = \int_0^1 f(x)g(x) dx$.}
